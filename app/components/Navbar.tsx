    ...
    <nav className="sticky top-0 z-[100] transition-all duration-300 backdrop-blur-xl bg-orange-950/80 text-white border-b border-white/10 shadow-[0_10px_40px_-15px_rgba(0,0,0,0.3)]">
      <div className="max-w-7xl mx-auto px-6 md:px-12 h-20 flex justify-between items-center">
        ...
        <div className="flex gap-6 md:gap-10 items-center">
          {/* Main Navigation with Underline Hover */}
          ...
          <div className="flex items-center gap-4">
            {session ? (
              ...
              <Link 
                href="/login" 
                className="relative overflow-hidden bg-white text-stone-950 px-8 py-2.5 rounded-full text-[10px] font-black uppercase tracking-widest hover:bg-orange-500 hover:text-white transition-all duration-300 shadow-xl active:scale-95"
              >
                Login
              </Link>
            )}
